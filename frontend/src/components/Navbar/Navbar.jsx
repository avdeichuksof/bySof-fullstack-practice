    ...
    const getTotalProducts = async () => {
        try {
            await axiosClient.getRequest({
                url: `${baseURL}/api/carts/${userCart}/items`,
                config: config,
                callbackSuccess: (res) => {
                    console.log('Prods in cart: ', res.data.totalProducts)
        ...
        <header className='header'>
            ...
            <nav>
                ...
                <ul className={`menu-${click ? 'mobile' : 'inline'}`}>
                    ...
                    <li>
                        <NavLink to={`/carts/${userCart}`} className='qtty-icon'>
                            <div className="menu-item cart-widget">
                                ...
                                {totalProducts > 0 && (
                                    <div className='widget-qtty'>{totalProducts}</div>
                                )}
                            </div>
                        </NavLink>
                    </li>
